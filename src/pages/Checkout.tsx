  ...
  if (orderPlaced) {
    return (
      <div className="container mx-auto flex flex-col items-center px-4 py-20 text-center">
        ...
        <p className="mt-2 text-muted-foreground">Thank you for your purchase. You can track your order in your account.</p>
        ...
        <div>
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <Button type="submit" className="w-full" disabled={placing || !cartItems?.length}>
